...
# Use the new optimized hyperparameters
best_params = {
    'algorithm': 'brute',
    'leaf_size': 5,
    'metric': 'chebyshev',
...
# Create and train the KNN model with optimized parameters
...
# Save the model
joblib.dump(knn_model, 'saved-models/KNN.pkl')
print("\nKNN model saved as 'saved-models/KNN.pkl'")